...
export default {
  ...
  data () {
    return [bookings, users, rooms, room, customers, events, extras, studios, login, refunds, documents, filters, finances, promo, discounts, jswidget, organizationNotes, promocodes, search].reduce(
